...
from tkinter import Tk, Frame, Grid, N,S,E,W,Button, END,X, Y, Toplevel, StringVar, Scrollbar, Text, LEFT, RIGHT
...
class Gui(Ui):
    ...
    def __play(self,r,c):
        # 5. When a game is won, subsequent clicks on buttons in the playing area should have no effect.
        if self.__finished:
            return
